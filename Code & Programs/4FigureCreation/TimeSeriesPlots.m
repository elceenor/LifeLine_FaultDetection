% Code to generate plots showing 2D plots (Parameter vs rotor speed, and
% parameter vs wind speed) and 3D plots (parameter vs parameter vs
% parameter) for any desired timeseries parameters as described on line 29.
