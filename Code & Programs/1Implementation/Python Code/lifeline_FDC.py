...
NSET_obj = NSET.NSET('/home/ryan/Documents/Masters/Programs/windy/turbine_control/GUI/fault_detection/NSET_memory.txt','/home/ryan/Documents/Masters/Programs/windy/turbine_control/GUI/fault_detection/NSET_inverse.txt',6,nrml)
SPRT_obj = SPRT.SPRT()

AFFT_obj = AFFT.AFFT()
AFFT_obj.load('/home/ryan/Documents/Masters/Programs/windy/turbine_control/GUI/fault_detection/AFFT_threshold.txt')
            ...
            if decoded == '':
                ...
                if len (values) == 8:
                    ...
                    try:
                        ...
                        # Update the plots if the data is good
                        update_gui ()
